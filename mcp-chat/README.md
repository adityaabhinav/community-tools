...
```
TS_HOST=https://ps-internal.thoughtspot.cloud
TS_TOKEN=your_bearer_token
TS_WORKSHEET_ID=your_worksheet_uuid
TS_PASSWORD=your_password        # optional — enables auto token refresh
TS_SECRET_KEY=your_secret_key    # optional — trusted-auth alternative to password
ANTHROPIC_API_KEY=sk-ant-...     # optional — only needed for "Claude + MCP" mode
